...
class Rapid_URL_Indexer_Customer {
    ...
    public static function enqueue_scripts() {
        ...
        wp_enqueue_script('chart-js-adapter', 'https://cdnjs.cloudflare.com/ajax/libs/chartjs-adapter-date-fns/2.0.0/chartjs-adapter-date-fns.bundle.min.js', array('chart-js'), '2.0.0', true);
